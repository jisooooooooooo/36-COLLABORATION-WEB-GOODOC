...
const ChatBubbleBot: React.FC<ChatBubbleBotProps> = ({ message, time }) => {
  return (
    <div className="w-[20.9375rem] h-[13.4375rem] flex items-start gap-[.75rem]">
      <ChatProfileIcon className="w-[2.25rem] h-[2.25rem] min-w-[2.25rem] min-h-[2.25rem] block" />
      <div className="flex flex-col">
        <div className="bg-White text-CGray-2 p-[.75rem] rounded-tr-[.75rem] rounded-br-[.75rem] rounded-bl-[.75rem]">
          {message}
        </div>
